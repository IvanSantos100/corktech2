                            ...
                            <tr>
                                ...
                                <td class="col-md-2  hidden-print">
                                    <ul class="list-inline">
                                        <li>
                                            <a class='btn btn-warning' href="{{ route('admin.centrodistribuicoes.edit', ['centrodistribuicao' => $centrodistribuicao->id]) }}"><span class='glyphicon glyphicon-edit'></span></a>
                                        </li>
                                        <li>
                                            <a class='btn btn-danger' href="{{ route('admin.centrodistribuicoes.show', ['centrodistribuicao' => $centrodistribuicao->id]) }}"><span class='glyphicon glyphicon-trash'></span></a>
                                        </li>
                                    </ul>
