                ...
                <div class="panel-heading">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td class="col-md-4">Origem: {{ $itens[0]->pedido->origem->descricao }}</td>
                                <td class="col-md-8">
                                    <div class="col-md-1">
                                        Destino:
                                    </div>
                                    @if($itens[0]->pedido->cliente)
                                        <div class="col-md-11">
                                        {{$itens[0]->pedido->cliente->nome}}
                                        </div>
                                    @else
                                        {!! Form::open(['route' => 'admin.orcamento.addcliente', 'class' => 'form']) !!}
                                        <div class="col-md-9">
                                        {!! Form::select('cliente_id', $clientes, null, ['class' => 'form-control w-4']) !!}
                                        {!! Form::hidden('pedido', $itens[0]->pedido->id) !!}
                                        </div>
                                        <div class="col-md-2">
                                        {!! form::submit('Add cliente', ['class' => 'btn btn-primary']) !!}
                                        </div>
                                        {!! Form::close() !!}
                                    @endif
                                </td>
                ...
                <div class="panel-body">
                    ...
                    <div class="pull-right hidden-print">
                        <a class="btn btn-primary"
                           href="{{route('admin.orcamento.additens', ['id' => $itens[0]->pedido_id])}}">Adicionar
                            Produto
                        </a>
